...
'			Me.dateEdit_Begin.EditValueChanged += New System.EventHandler(Me.dateEdit_EditValueChanged);
			' 
			' dateEdit_End
			' 
...
'			Me.dateEdit_End.EditValueChanged += New System.EventHandler(Me.dateEdit_EditValueChanged);
			' 
			' progressBarControl1
			' 
...
'			Me.dateEdit_Now.EditValueChanged += New System.EventHandler(Me.dateEdit_EditValueChanged);
			' 
			' labelControl1
			' 
		...
		Private WithEvents dateEdit_Begin As DevExpress.XtraEditors.DateEdit
		Private WithEvents dateEdit_End As DevExpress.XtraEditors.DateEdit
		Private progressBarControl1 As DevExpress.XtraEditors.ProgressBarControl
		Private WithEvents dateEdit_Now As DevExpress.XtraEditors.DateEdit
