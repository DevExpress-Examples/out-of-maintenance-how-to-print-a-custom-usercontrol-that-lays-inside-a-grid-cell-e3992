...
'#End Region
        ...
        Public Sub New()
            MyBase.New()
            AddHandler Properties.ControlTypeChanged, New EventHandler(AddressOf Properties_ControlTypeChanged)
            UpdateControls()
        ...
        Private Sub UpdateControls()
            Controls.Clear()
            If Properties.ControlType Is Nothing Then Return
            Controls.Add(Properties.EditorControl)
            AddHandler TryCast(Properties.EditorControl, IEditValue).EditValueChanged, New EventHandler(AddressOf editor_EditValueChanged)
        ...
        Public Overloads ReadOnly Property Properties As CustomRepositoryItem
            Get
